...
export interface IfoInterface extends utils.Interface {
  functions: {
    "HARVEST_PERIODS()": FunctionFragment;
    ...
    "getOfferingAmountPerPeriod(address)": FunctionFragment;
    ...
    "harvestReleaseBlocks(uint256)": FunctionFragment;
    "hasHarvested(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "HARVEST_PERIODS",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getOfferingAmountPerPeriod",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "harvestReleaseBlocks",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "hasHarvested",
...
export interface Ifo extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IfoInterface;
  ...
  functions: {
    HARVEST_PERIODS(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    userInfo(
      arg0: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber, boolean] & { amount: BigNumber; refunded: boolean }>;
    ...
    userTokenStatus(
      ...
      [BigNumber, BigNumber, BigNumber] & {
        ...
        offeringTokenHarvest: BigNumber;
  ...
  populateTransaction: {
    HARVEST_PERIODS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
