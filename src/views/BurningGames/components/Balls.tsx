...
import { Svg, SvgProps, Text, Flex } from '@apeswapfinance/uikit'
...
export const BallWithNumber: React.FC<BallWithNumberProps> = ({ color, number, size, fontSize, rotationTransform }) => {
  ...
  return (
    <div style={{position:'relative', width: size, height:size, marginLeft: 5}}>
      <BallComponent width={size ?? '50px'} height={size ?? '50px'} />
      <BallTextWrapper>
