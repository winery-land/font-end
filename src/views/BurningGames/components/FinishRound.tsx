      ...
      <MaindCard>
        <HeaderCard>
          <RowBetween>
            ...
            <Row>
              ...
              <ArrowForwardIcon onClick={goToNextRound} color={round < (currentRow - 2) ? 'black' : 'gray'} width={24} style={{ marginLeft: 15 }} />
            </Row>
          </RowBetween>
        </HeaderCard>
        {(round >= 0 && currentRow !== 1) ? <>
          ...
          </RowWinningNum>
          {
            isOpenDetail &&
            (
              isLoading ? <PrizeDetailLoading />
                : <PrizeDetail data={dataShow} isOpen={isOpenDetail}/>
            )
          }
          <Line />
