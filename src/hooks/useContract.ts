...
import winery from 'config/abi/winery.json'
...
export const useLottery = () => {
  ...
  return useSafeContract(abi, useLotteryAddress())
}

export const useWineryToken = () => {
  const abi = winery as unknown as AbiItem
  return useSafeContract(abi, useWineryAddress())
}


export const useLotteryTicket = () => {
  const abi = lotteryTicket as unknown as AbiItem
  return useSafeContract(abi, useLotteryTicketAddress())
}
