...
const Header = styled.div`
  ...
  padding-left: 10px;
  padding-right: 10px;
  //background-image: ${({ theme }) => theme.isDark ? 'url(/images/pool-background-night.svg)' : 'url(/images/pool-background-day.svg)'};
...
const Pools: React.FC = () => {
  ...
  return (
    <>
      <Header>
        <HeadingContainer>
          <StyledHeading as="h1" mb="8px" mt={0} color="white" fontWeight={700}>
            {/* {TranslateString(999, 'Banana Pools')} */}
            Champagne
          </StyledHeading>
          {size.width > 968 && (
            <StyledSubHeading fontSize="22px" fontWeight={400} color="white">
              Stake CORK tokens to more new token. <br /> High APR, low risk.
            </StyledSubHeading>
          )}
        </HeadingContainer>
        {/* <MonkeyWrapper>
      ...
      <StyledPage width="1130px">
        ...
        {viewMode !== ViewMode.CARD && <ContainerLabels>
